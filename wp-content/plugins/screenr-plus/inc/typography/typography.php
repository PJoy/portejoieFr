 ...
 */
function screenr_sanitize_typography_field( $value ){
...
function screenr_typography_get_default_fonts() {
    ...
    return apply_filters( 'screenr_typography_get_default_fonts', $fonts );

}


function screenr_typography_get_google_fonts(){
    /**
    ...
    return apply_filters( 'screenr_typography_get_google_fonts', $fonts );
}

function screenr_typography_get_fonts(){
    //delete_transient( 'wp_typography_fonts' ); // for debug
    if ( false === ( $fonts = get_transient( 'wp_typography_fonts' ) ) ) {
        $fonts = array_merge( screenr_typography_get_default_fonts(), screenr_typography_get_google_fonts() );
...
if ( class_exists( 'WP_Customize_Control' ) ) {
     ...
     * @access public
     */
    class Screenr_Customize_Typography_Control extends WP_Customize_Control {
        ...
        public function __construct( $manager, $id, $args = array() ) {
            ...
            $this->l10n = wp_parse_args(
                $this->l10n,
                array(
                    'family'            => esc_html__( 'Font Family', 'screenr-plus' ),
                    'option_default'    => esc_html__( 'Default', 'screenr-plus' ),
                    'size'              => esc_html__( 'Font Size (px)',   'screenr-plus' ),
                    'style'             => esc_html__( 'Font Weight/Style',  'screenr-plus' ),
                    'line_height'       => esc_html__( 'Line Height (px)', 'screenr-plus' ),
                    'text_decoration'   => esc_html__( 'Text Decoration', 'screenr-plus' ),
                    'letter_spacing'    => esc_html__( 'Letter Spacing (px)', 'screenr-plus' ),
                    'text_transform'    => esc_html__( 'Text Transform', 'screenr-plus' ),
        ...
        public static function get_url( ){
            return  SCREENR_PLUS_URL.'inc/typography/';
        }

        public static function get_default_fonts() {
            return screenr_typography_get_default_fonts();
        }
        ...
        static function get_google_fonts(){
            return screenr_typography_get_google_fonts();
        }

        public static function get_fonts(){
            return screenr_typography_get_fonts();
        }
        ...
        public function enqueue() {
            ...
            wp_localize_script('jquery', 'fontStyleLabels', array(
                '100'       => __( 'Thin 100', 'screenr-plus' ),
                '100italic' => __( 'Thin 100 Italic', 'screenr-plus' ),
                '200'       => __( 'Extra-Light 200' ),
                '200italic' => __( 'Extra-Light 200 Italic', 'screenr-plus' ),
                '300'       => __( 'Light 300' ),
                '300italic' => __( 'Light 300 Italic', 'screenr-plus' ),
                '400'       => __( 'Normal 400' ),
                '400italic' => __( 'Normal 400 Italic', 'screenr-plus' ),
                'regular'   => __( 'Normal' ),
                'italic'    => __( 'Normal Italic', 'screenr-plus' ),
                '500'       => __( 'Medium 500' ),
                '500italic' => __( 'Medium 500 Italic', 'screenr-plus' ),
                '600'       => __( 'Semi-Bold 600' ),
                '600italic' => __( 'Semi-Bold 600 Italic', 'screenr-plus' ),
                '700'       => __( 'Bold 700', 'screenr-plus' ),
                '700italic' => __( 'Bold 700 Italic', 'screenr-plus' ),
                '800'       => __( ' Extra-Bold 800' ),
                '800italic' => __( ' Extra-Bold 800 Italic', 'screenr-plus' ),
                '900'       => __( 'Ultra-Bold 900', 'screenr-plus' ),
                '900italic' => __( 'Ultra-Bold 900 Italic', 'screenr-plus' ),
            ) );
                ...
                <div class="typography-settings">
                    ...
                    <ul>
                        ...
                        <li class="typography-font-size typography-half right">
                            ...
                            <input class="unit-value font-size" placeholder="<?php esc_attr_e( 'Default', 'screenr-plus' ); ?>" type="number" min="1" />
                        </li>
                        <# } #>
                        ...
                        <li class="typography-line-height first typography-half">
                            ...
                            <input class="unit-value line-height" placeholder="<?php esc_attr_e( 'Default', 'screenr-plus' ); ?>" type="number" min="1" />
                        </li>
                        <# } #>
                        ...
                        <li class="typography-letter-spacing typography-half right">
                            ...
                            <input class="unit-value letter-spacing" placeholder="<?php esc_attr_e( 'Default', 'screenr-plus' ); ?>" type="number" />
                        </li>
                        <# } #>
                        ...
                        <li class="typography-text-decoration clr">
                            ...
                            <select class="text-decoration">
                                <option value=""><?php esc_attr_e( 'Default', 'screenr-plus' ); ?></option>
                                <option value="none"><?php esc_attr_e( 'None', 'screenr-plus' ); ?></option>
                                <option value="overline"><?php esc_attr_e( 'Overline', 'screenr-plus' ); ?></option>
                                <option value="underline"><?php esc_attr_e( 'Underline', 'screenr-plus' ); ?></option>
                                <option value="line-through"><?php esc_attr_e( 'Line through', 'screenr-plus' ); ?></option>
                            </select>
                        </li>
                        <# } #>
                        ...
                        <li class="typography-text-transform clr">
                            ...
                            <select class="text-transform" >
                                <option value=""><?php esc_attr_e( 'Default', 'screenr-plus' ); ?></option>
                                <option value="none"><?php esc_attr_e( 'None', 'screenr-plus' ); ?></option>
                                <option value="uppercase"><?php esc_attr_e( 'Uppercase', 'screenr-plus' ); ?></option>
                                <option value="lowercase"><?php esc_attr_e( 'Lowercase', 'screenr-plus' ); ?></option>
                                <option value="capitalize"><?php esc_attr_e( 'Capitalize', 'screenr-plus' ); ?></option>
                            </select>
                        </li>
                        <# } #>
